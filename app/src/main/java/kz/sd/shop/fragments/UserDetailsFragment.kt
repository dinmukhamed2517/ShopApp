...
import kz.sd.shop.base.SharedViewModel
import kz.sd.shop.databinding.FragmentUserDetailsBinding
    ...
    override fun onBindView() {
        ...
        with(binding){
            ...
            nextBtn.setOnClickListener {
                ...
                if(addressInput.text?.isEmpty() == true){
                    addressLayout.error = "Fill up"
                    addressLayout.isErrorEnabled = true
                    ok = false
                }
                else{
                    addressLayout.isErrorEnabled = false
                    viewModel.address = addressInput.text.toString()
                    ok = true
                }
                if (ok) {
                    val user = User(
                    ...
                    findNavController().navigate(
                        R.id.action_userDetailsFragment_to_home
                    )
                }
            }
        }
